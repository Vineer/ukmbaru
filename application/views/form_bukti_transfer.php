                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="main-title text-center wow fadeInUp">
                            <h2>Konfirmasi Bukti Transfer Pemesanan Tiket UKM </h2>
                        </div>
                    </div>
                </div>
                <!--title-->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="woocommerce">
                                <form method="post" class="checkout woocommerce-checkout" action="<?php echo site_url('ukm/input_data_bukti_transfer'); ?>" enctype="multipart/form-data">
                                    ...
                                    <?php endif ?>                                    
                                        <div class="col-1">
                                            <div class="woocommerce-billing-fields">
                                                <h4 class="title">Formulir Konfirmasi Bukti Transfer</h4>
                                                <div class="row">
