            ...
            <div id="content">
                <section>
                    ...
                    <div class="section-body contain-lg">
                        ...
                        <!-- BEGIN SUMMERNOTE -->
                        <form class="form" role="form" method="post" action="<?php echo base_url()?>admin/UKM/UpdatePengumuman/<?= $query->id_pengumuman ?>">
                            <div class="form-group floating-label">
                                <input type="hidden" class="form-control input-lg" id="id" name="id" value="<?= $query->id_pengumuman ?>">
                                <input type="text" class="form-control input-lg" id="jenis" name="jenis" value="<?= $query->jenis_pengumuman ?>">
                                <label for="large2">Jenis Pengumuman</label>
                                <?php echo form_error('jenis'); ?>
                            </div>
                            <div class="form-group floating-label">
                                <input type="text" class="form-control input-lg" id="judul" name="judul" value="<?= $query->judul ?>">
                                <label for="large2">Judul Pengumuman</label>
                                <?php echo form_error('judul'); ?>
                            </div>
                            <div class="card">
                                <div class="card-body no-padding">
                                    <textarea class="input-block-level" id="summernote" name="summernote" rows="18"><?= $query->isi_pengumuman ?></textarea>
                                </div><!--end .card-body -->
                            </div>
