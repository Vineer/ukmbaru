            ...
            <div id="content">
                <section>
                    <div class="section-header">
                        <ol class="breadcrumb">
                            <li class="active">Edit LPJ</li>
                        </ol>
                    </div>
                    <div class="section-body contain-lg">
                    <?php foreach ($datalpj as $record) {
                        ?> 

                                                  <!-- BEGIN SUMMERNOTE -->
                        <form class="form" role="form" method="post" action="<?php echo base_url();?>admin/UKM/UpdateLpj/<?=$record->id_lpj?>" enctype="multipart/form-data">
                            <div class="form-group floating-label">
                                <input type="text" class="form-control input-lg" id="id_lpj" name="id_lpj" value="<?php echo $record->id_lpj; ?>">
                                <label for="large2">Kode LPJ</label>
                                <?php echo form_error('id_lpj'); ?>
                            </div>
                            <div class="form-group floating-label">
                                <input type="text" class="form-control input-lg" id="judul_lpj" name="judul_lpj" value="<?php echo $record->judul_lpj; ?>">
                                <label for="large2">Judul LPJ</label>
                                <?php echo form_error('judul_lpj'); ?>
                            </div>
                            <div class="form-group floating-label">
                            ...
                            <div class="">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" id="lpj" name="lpj" accept="application/pdf" value="<?php echo $record->file; ?>">
                                                        <label for="Lastname3">File LPJ</label>
                                                    </div>
                                                </div>
                            <div>
