			...
			<div id="content">
				<section class="style-default-bright">
					...
					<div class="section-body">
						<div class="row">
							<a href="<?php echo base_url()?>admin/UKM/TambahArtikel"><button type="button" class="btn ink-reaction btn-raised btn-primary col-sm-offset-0">Tambah Artikel</button></a>
							<br><br>
							<div class="col-lg-12">
								<div class="table-responsive">
									<table id="datatable2" class="table order-column hover">
										...
										<tbody>
											...
											<tr class="gradeX">
												<td><?php echo $i?></td>
												<td><?php echo $a->kd_artikel?></td>
												<td><?php echo $a->penerbit?></td>
												<td><?php echo $a->kategori?></td>
												<td><?php echo $a->tgl_terbit?></td>
												<td><?php echo $a->judul?></td>
												<td><?php echo $a->konten?></td>
												<td><center>
													<a href="<?php echo base_url()?>admin/UKM/EditArtikel/<?php echo $a->kd_artikel?>">
