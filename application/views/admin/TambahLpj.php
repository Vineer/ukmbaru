			...
			<div id="content">
				<section>
					<div class="section-header ">
						<ol class="breadcrumb">
							<li class="active">Tambah LPJ</li>
						</ol>
					</div>
					<div class="section-body contain-lg">

						<!-- BEGIN INVERSED FORM -->
						  <form class="form" role="form" method="post" action="<?php echo base_url()?>admin/UKM/SimpanLpj" enctype="multipart/form-data">
                            <div class="form-group floating-label">
                                <input type="text" class="form-control input-lg" id="judul_lpj" name="judul_lpj">
                			...
                			<div class="">
														...
														<input type="file" class="form-control" id="lpj" name="lpj" accept="application/pdf">
