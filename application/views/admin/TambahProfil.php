            ...
            <div id="content">
                <section>
                    ...
                    <div class="section-body contain-lg">
                        ...
                        <!-- BEGIN SUMMERNOTE -->
                        <form class="form" role="form" method="post" ecntype="multipart/form-data" 
                        action="<?php echo base_url()?>admin/UKM/SimpanProfil">
                            ...
                            <div class="form-group floating-label">
                                <input type="text" class="form-control input-lg" id="slogan" name="slogan">
                            ...
                            <div class="card">
                                <div class="card-body no-padding">
                                    <textarea class="input-block-level" id="summernote" name="deskripsi" rows="18"></textarea>
                                </div><!--end .card-body -->
                            </div>
