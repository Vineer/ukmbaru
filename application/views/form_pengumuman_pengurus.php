                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="woocommerce">
                                <form method="POST" class="checkout woocommerce-checkout" action="<?php echo site_url('ukm/cari_pengurus'); ?>">
                                    <div class="col2-set" id="customer_details">
                                        <div class="col-1">
                                            <div class="woocommerce-billing-fields">
                                                <h4 class="title">Hasil Seleksi Pengurus UKM</h4>
                                                <div class="row">
                    ...
                    if (isset($query)) { 
                        foreach ($query as $row) {
                            if ($row->status == 'Diterima') {
                                $stat = 'Selamat Anda Lolos Seleksi Pengurus UKM';
                            }
                            else{
                                $stat = 'Maaf, Anda tidak Lolos Seleksi Pengurus UKM.
